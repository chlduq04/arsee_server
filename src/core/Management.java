...
public class Management extends Database{
	...
	public String modifyDB(String id, String text, String starttime, String endtime, String indexs, String type ) throws SQLException{
		...
		int count = 0;
		if(type.equals(ARS_DATA_TYPE_INFO)){
			count = makePstmtUpdate("UPDATE arsee_ars_infos SET text = ?, starttime = ?, endtime = ?, indexs = ?, "+ARS_DATA_TYPE_INFO+" = '1', "+ARS_DATA_TYPE_ERROR+" = NULL, "+ARS_DATA_TYPE_SHARP+" = NULL, "+ARS_DATA_TYPE_STAR+" = NULL, "+ARS_DATA_TYPE_NORMAL+" = NULL WHERE id = ? LIMIT 1", text, starttime, endtime, indexs, id);		
		}else if(type.equals(ARS_DATA_TYPE_ERROR)){
			count = makePstmtUpdate("UPDATE arsee_ars_infos SET text = ?, starttime = ?, endtime = ?, indexs = ?, "+ARS_DATA_TYPE_INFO+" = NULL, "+ARS_DATA_TYPE_ERROR+" = '1', "+ARS_DATA_TYPE_SHARP+" = NULL, "+ARS_DATA_TYPE_STAR+" = NULL, "+ARS_DATA_TYPE_NORMAL+" = NULL WHERE id = ? LIMIT 1", text, starttime, endtime, indexs, id);		
		}else if(type.equals(ARS_DATA_TYPE_SHARP)){
			count = makePstmtUpdate("UPDATE arsee_ars_infos SET text = ?, starttime = ?, endtime = ?, indexs = ?, "+ARS_DATA_TYPE_INFO+" = NULL, "+ARS_DATA_TYPE_ERROR+" = NULL, "+ARS_DATA_TYPE_SHARP+" = '1', "+ARS_DATA_TYPE_STAR+" = NULL, "+ARS_DATA_TYPE_NORMAL+" = NULL WHERE id = ? LIMIT 1", text, starttime, endtime, indexs, id);					
		}else if(type.equals(ARS_DATA_TYPE_STAR)){
			count = makePstmtUpdate("UPDATE arsee_ars_infos SET text = ?, starttime = ?, endtime = ?, indexs = ?, "+ARS_DATA_TYPE_INFO+" = NULL, "+ARS_DATA_TYPE_ERROR+" = NULL, "+ARS_DATA_TYPE_SHARP+" = NULL, "+ARS_DATA_TYPE_STAR+" = '1', "+ARS_DATA_TYPE_NORMAL+" = NULL WHERE id = ? LIMIT 1", text, starttime, endtime, indexs, id);		
		}else if(type.equals(ARS_DATA_TYPE_NORMAL)){
			count = makePstmtUpdate("UPDATE arsee_ars_infos SET text = ?, starttime = ?, endtime = ?, indexs = ?, "+ARS_DATA_TYPE_INFO+" = NULL, "+ARS_DATA_TYPE_ERROR+" = NULL, "+ARS_DATA_TYPE_SHARP+" = NULL, "+ARS_DATA_TYPE_STAR+" = NULL, "+ARS_DATA_TYPE_NORMAL+" = '1' WHERE id = ? LIMIT 1", text, starttime, endtime, indexs, id);		
		}else{
	...
	public String findOthers(String number, String company, String depth, String index, String parent) throws SQLException{
		initializeDB();
		JSONObject result = new JSONObject();
		String find_other_datas = "SELECT id, text, count FROM arsee_ars_infos_update WHERE company = ? and number = ? and depth = ? and indexs = ? and parent = ? order by count desc";
