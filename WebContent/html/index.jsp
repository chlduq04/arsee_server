...
<div class="index_main">
	<div class="main_left">
		<div class="ml_clickbox">
			<img class="ml_clickbox_img" src="../images/starticon.png" alt=" "/>
		</div>
	...
	<div class="main_center">
		<div class="mc_clickbox">
			<img class="mc_clickbox_img" src="../images/cameraicon.png" alt=" "/>
		</div>
	...
	<div class="main_right">
		<div class="mr_clickbox">
			<img class="mr_clickbox_img" src="../images/listicon.png" alt=" "/>
		</div>
